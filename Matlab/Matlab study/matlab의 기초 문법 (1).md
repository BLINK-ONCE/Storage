...
## 간단한 계산 명령어
명령어를 입력한 후 엔터를 누르면 matlab이 명령어를 실행한다. 그리고 명령어가 실행되면 입력한 명령어 다음 줄부터 실행된 결과물이 표시된다.
...
명령어 다음 줄에 결과물이 출력된다. 이를 출력 되지 않게 하려면 세미콜론;을 붙이면 된다.
...
# Reference
- [matlab 기초 문법(1)](https://kookyungmin.github.io/language/2017/09/05/matlab01/)